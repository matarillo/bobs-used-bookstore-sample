...
| （基底属性） | | | | [03-building-blocks.md](03-building-blocks.md) §1 |
...
種別を生成時に固定することで、[INV-CLASS-01](03-building-blocks.md) が
...
| 照会 | 引数 | 戻り |
| --- | --- | --- |
| 全件取得 | — | すべての項目。**分類の検証にはこれが必要**（[VO-CLASSIFICATION](03-building-blocks.md) §4.2） |
...
詳細は [ISSUE-12](15-design-issues.md)。
