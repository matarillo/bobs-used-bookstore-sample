...
| **保証** | すでにその住所を使った注文は、引き続き配送先を参照できる（[INV-ADDR-06](06-aggregate-customer-address.md)） |
...
方針の違いは [POL-NOTFOUND](10-domain-services-and-policies.md) による。
...
| **手順** | [10-domain-services-and-policies.md](10-domain-services-and-policies.md) §6.1 を参照 |
...
| **保証** | 注文・在庫・かごは**同一の単位作業**で確定する（[02](02-domain-overview.md) §8） |
...
| **注意** | 顧客の存在が検査されていない（[ISSUE-04](15-design-issues.md)） |
...
| **保証** | 入力に種別が含まれないため、すでに書籍やオファーが分類に用いている項目の**意味が変わることはない**（[INV-REFDATA-02](04-aggregate-reference-data.md)） |
...
**画像の扱い**（[POL-IMAGE-SAFETY](10-domain-services-and-policies.md) §5）
...
[13-read-models-and-statistics.md](13-read-models-and-statistics.md) を参照。
