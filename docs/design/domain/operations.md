...
| **手順** | [10-domain-services-and-policies.md](services-and-policies.md) §6.1 を参照 |
...
| **保証** | 注文・在庫・かごは**同一の単位作業**で確定する（[02](overview.md) §8） |
...
[13-read-models-and-statistics.md](read-models.md) を参照。
