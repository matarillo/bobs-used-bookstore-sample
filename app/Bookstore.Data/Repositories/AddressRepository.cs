...
namespace Bookstore.Data.Repositories
{
    public class AddressRepository : IAddressRepository
    {
        ...
        {
            // Returns null when no active address matches; callers check for that even though the
            // interface keeps the return type non-nullable (see IOfferRepository.GetAsync(string,
            // int) for the same shape). The null-forgiving operator here just matches that
            // existing, deliberate contract.
