...
namespace Bookstore.Domain.Addresses
{
    ...
    public class AddressService : IAddressService
    {
        ...
        {
            // The one place a customer may be created without already existing — the customer's
            // first address is often also their first contact with the domain.
            ...
            // The customer and the address are one change. Committing the customer separately
            // would leave a customer behind if the address then failed.
            await unitOfWork.CompleteAsync();
        }

        // Updating one specifically-identified address is a strict update.
        ...
        // Deleting one specifically-identified address is a strict update too, the same policy
        // used for a shopping cart item (RemoveShoppingCartItemById).
